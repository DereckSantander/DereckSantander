...
# 👋 ¡Hola! Soy Dereck Santander

### 💻 Desarrollador de Software | 🎓 Estudiante de Ingeniería en Ciencias Computacionales
...
Bienvenido a mi repositorio personal. Soy un apasionado estudiante de **Ingeniería en Ciencias Computacionales** en la **ESPOL** 🐢, con 21 años de edad y ubicado en **Ecuador** 🇪🇨.
...
### 🎮 [Tienda de Videojuegos](https://github.com/DereckSantander/EDD-G3.git)
**Tecnología:** Java

Sistema de gestión de tienda de videojuegos desarrollado aplicando estructuras de datos avanzadas.

</td>
<td width="25%">

### 👶 [Registro de Citas de Terapia](https://github.com/DereckSantander/Proyecto-POO.git)
**Tecnología:** Java

Aplicación para gestionar citas de terapia infantil utilizando programación orientada a objetos.

</td>
<td width="25%">

### 📊 [Análisis Estadístico ESPOL](https://github.com/DereckSantander/ProyectoEstadistica.git)
**Tecnología:** R

Análisis estadístico completo de datos de estudiantes de ESPOL con visualizaciones y reportes.

</td>
<td width="25%">

### 🩸 [Sistema de Banco de Sangre](https://github.com/DereckSantander/BDD-BancoDeSangre.git)
**Tecnología:** SQL + Java

Sistema integral de gestión de banco de sangre con base de datos robusta.
...
<sub>⭐ Si te gusta mi trabajo, ¡no olvides dar una estrella a mis repositorios!</sub>
